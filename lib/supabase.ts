...
// Use fallback values if environment variables are not set (e.g., during build)
// This allows the build to succeed, and runtime error handling will show appropriate messages
